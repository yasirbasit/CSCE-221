...
int main(){
        ...
        collection_2.insert_item(stress_ball_1);
                    // cout << "#####Testing: Pring collection_2...######" << collection_2.total_items() << endl;
                    // collection_2.print_items();
                    // cout << "------------" << endl;
        //collection_file.print_items();
        collection_3 = make_union(collection_file,collection_2);
            // cout << "finished make_union" << endl;
                    // cout << "######Testing: Pring collection_2...#####" << collection_2.total_items() << endl;
                    // collection_2.print_items();
                    // cout << "------------" << endl;
        if(collection_3.total_items() == (collection_file.total_items() + collection_2.total_items())){
                // cout << "into fisrt loop" << endl;
                // cout << "Pring collection_2..." << collection_2.total_items() << endl;
                // collection_2.print_items();
                // cout << "------------" << endl;
                // cout << "Finish pring collection_2..." << collection_2.total_items() << endl;
                // cout << "c3: " << collection_3.total_items(Stress_ball_colors::yellow) << endl;
                // cout << "fi: " << collection_file.total_items(Stress_ball_colors::yellow) << endl;
                // cout << "c2: " << collection_2.total_items(Stress_ball_colors::yellow) << endl; 
